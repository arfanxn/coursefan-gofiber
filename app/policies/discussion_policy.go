...
func (policy *DiscussionPolicy) Create(c *fiber.Ctx, input requests.ReviewCreate) (err error) {
...
func (policy *DiscussionPolicy) CreateByLecture(c *fiber.Ctx, input requests.ReviewCreate) (err error) {
...
func (policy *DiscussionPolicy) Update(c *fiber.Ctx, input requests.ReviewUpdate) (err error) {
...
func (policy *DiscussionPolicy) Delete(c *fiber.Ctx, input requests.ReviewDelete) (err error) {
